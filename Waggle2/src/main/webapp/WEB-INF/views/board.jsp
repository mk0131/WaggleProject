                    ...
                    <c:forEach items="${list }" var="dto" varStatus="status">
                        <div class="board-content-all" id="content-all">
                            ...
                            <div class="board-content-inner" id="board-img"
                                 onclick="location.href='/board/detail?req_No=${dto.req_No}'">
                            ...
                            <div id="board-text">
                                ...
                                <div class="board-content-inner" id="board-title"
                                     onclick="location.href='/board/detail?req_No=${dto.req_No}'">${dto.req_Title }</div>
                                <div class="board-content-inner" id="board-point"
                                     onclick="location.href='/board/detail?req_No=${dto.req_No}'">${dto.req_Point }&nbsp;P</i></div>

                                <h4 class="board-content-inner" id="board-ltd-title"
                                    onclick="location.href='/board/detail?req_No=${dto.req_No}'">요청 정보</h4>
        ...
        <c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="num">
            <li>
                <a class="${paging.cri.page == num ? 'nowpage' : null }" id="paging-a"
                   href='<c:url value="/board/list?page=${num}"/>'>${num}</a>
            </li>
                
        </c:forEach>
