                    ...
                    <form onsubmit="return false">
                        <div id="area">
                            <div class="input-group">
                                <textarea class="input" id="chat_Content" autocomplete="off"
                                          placeholder="건전한 채팅 문화를 만들어 갑시다."></textarea>
                                <button class="btn" id="send" disabled="disabled"><img id="btn_img" alt="send"
                                                                                       src="https://cdn-icons-png.flaticon.com/512/149/149444.png">
                                </button>
                            </div>
                        </div>
                    </form>
...
<script type="text/javascript">
    ...
    $(document).on("dblclick", "div[id='list_1']", function () {
        ...
        ChatHistory();
        var timer = setTimeout(down, 1000);
