		...
		<div class="ongoing21-all">
			...
			<div class="last-content">
				...
				<form action="/board/rerating" method="post">
					<input type="hidden" name="req_No" value="${req_dto.req_No }">
					<input type="hidden" id="bee_rating" name="ur_Rate"> <input
						type="hidden" name="sum_val" value="${sum_val }">
					...
					<div class="btn2" id="btn2">
						<button type="submit" value="평가" style="margin-right: 80px;">꿀벌
							재평가 완료</button>
	    ...
	    <table class="ongoing21-content">
	     ...
	     <div class="ongoing21-content-bottom">
		  ...
		  <form action="/board/rerating" method="post">
		   ...
		   <input type="hidden" name="sum_val" value="${sum_val }">
	       <table class="ongoing21-content2 rate_bee_table">
		       <tbody>
		        <tr>
		       	 <th>
...
$(window).scroll(  function() {
	 ...
	 if(nVScroll > 930 && nVScroll <=1350) {
		 $(".imp").css("position", "fixed").css("top", "135" + "px")
	} else if(nVScroll > 1350){
		$(".imp").css("position", "relative").css("top", "480" + "px")
	}
	else {
