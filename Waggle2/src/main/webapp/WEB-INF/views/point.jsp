        ...
        <div class="middle-top">
            ...
            <div class="money-container">
                ...
                <form>
                    <div class="money">
                        <div class="img-x">
                            <input id="price" class="point-amount" type="text" style="background-color:transparent;"
                                   required placeholder="아래 버튼을 눌러 금액을 입력해주세요" readonly="readonly"><span
                                class="bar"></span>
                        </div>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <c:forEach var="dto" items="${list}">
                                <div class="pointuse"
                                     style="border-bottom: 1px solid #898989; width:1000px; height:130px; margin-top:18px">
                                    ...
                                    <div class="use-middle"
                                         style="width:650px; height:110px; padding-left:35px; display:inline-block">
                                        <fmt:parseDate value="${dto.date }" pattern="yyyy-MM-dd'T'HH:mm"
                                    ...
                                    <div class="use-right"
                                         style="width:200px; height:110px; display:inline-block; text-align:center; float:right">
                                        <c:choose>
                                            <c:when test="${dto.type eq '사용'}">
                                                <div style="font-size:30pt; margin-top:25px; color:#e37b7b;">
                                                    -${dto.price} P
                                                </div>
                                            </c:when>
                                            <c:otherwise>
                                                <div style="font-size:30pt; margin-top:25px; color:#3a6589bf;">
                                                    +${dto.price} P
                                                </div>
                                            </c:otherwise>
                                        </c:choose>
                ...
                <div>
                    <ul class="paging">
                        ...
                        <c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="num">
                            <li>
                                <a class="${paging.cri.page == num ? 'nowpage' : null }" id="paging-a"
                                   href='<c:url value="/point/use?page=${num}"/>'>${num}</a>
                            </li>
                                
                        </c:forEach>
