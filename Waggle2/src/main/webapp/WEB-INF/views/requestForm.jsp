        ...
        <div class="ongoing21-all">
            <form onsubmit="return loading()" action="/board/request" method="post">
                ...
                <table class="ongoing21-content">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="link-guide"
                               onclick="window.open('/images/importToJsp/링크첨부방법.gif', 'window_name', 'width=1000, height=600, location=no, status=no, scrollbars=yes')">링크
                                첨부방법 확인</a>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" placeholder="Point(숫자만 입력하세요)" name="req_Point" required="required"
                                   oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"/>
                        </td>
                    </tr>
                    <tr>
                        <th>공인중개사 연락처</th>
                        <td><input type="text" placeholder="010-0000-0000(선택사항)" name="req_Phone" maxlength='13'
                ...
                <div class="ongoing21-content-bottom">
                    <h4>자세하게 봐야 될 부분</h4>
                    <textarea id="incontent" rows="12" cols="70"
                              placeholder="요구사항을 입력해주세요&nbsp;ex.수압이나 바깥전망, 소음 등 원하는 사진이나 동영상이 필요한 부분을 적어주세요"
                              name="req_Detail"></textarea>
                    <br><br>
