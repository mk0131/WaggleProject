                ...
                <tr class="${con_dto.co_Confirm }">
                    ...
                    <td>
                        <button class="table-btn"
                                onclick="window.open('${con_dto.fi_Nm}', 'window_name', 'width=430, height=500, location=no, status=no, scrollbars=yes')">
                            <span>첨부이미지확인</span></button>
                    </td>
                    <td>
                        <button class="table-btn" onclick="permit([${con_dto.co_UCode }])"><span>확인처리</span></button>
                        &nbsp;
                        <button class="table-btn" onclick="reject([${con_dto.co_UCode }])"><span>반려처리</span></button>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
