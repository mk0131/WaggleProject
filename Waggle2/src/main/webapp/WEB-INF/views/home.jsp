...
<head>
    ...
    <script type="text/javascript">
        ...
        function naverSignInCallback() {
            ...
            let data = {
                user_Email: naver_id_login.getProfileData('email'), user_Naver: naver_id_login.getProfileData('id'),
    ...
    <div class="section">
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide"><img src="/images/mainhome/Frame2.jpg">
                    <div id="gopagebtn1" onclick="location.href='/board/requestform'"></div>
                </div>
                <div class="swiper-slide"><img src="/images/mainhome/Frame3.jpg">
                    <div id="gopagebtn2" onclick="location.href='/board/list'"></div>
                </div>
        ...
        <div class="mainhome-bottom">
            ...
            <div class="inquiry-notice">
                ...
                <div class="notice-detail-title" onclick="location.href='/inquiry/list?user_Code=${user_Code}'">[공지]
                    WAGGLE 카카오페이 결제 관련 안내
                </div>
                <div class="notice-detail-title" onclick="location.href='/inquiry/list?user_Code=${user_Code}'">[공지]
                    WAGGLE 카카오페이 결제 관련 안내
                </div>
                <div class="notice-detail-title" onclick="location.href='/inquiry/list?user_Code=${user_Code}'">[공지]
                    WAGGLE 개인정보 처리방침(2022/08/02) 개정 안내
                </div>
                <div class="notice-detail-title" onclick="location.href='/inquiry/list?user_Code=${user_Code}'">[공지]
                    WAGGLE 개인정보 처리방침(2022/06/30) 개정 안내
                </div>
                <div class="notice-detail-title" onclick="location.href='/inquiry/list?user_Code=${user_Code}'">[공지]
                    WAGGLE 개인정보 처리방침(2022/05/12) 개정 안내
                </div>
            </div>
        </div>
