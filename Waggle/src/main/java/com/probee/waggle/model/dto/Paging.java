...
public class Paging {
	...
	private int totalCount; // 게시판 전체 데이터 갯수
	private int displayPageNum = 10; // 게시판 화면에서 한번에 보여질 페이지 번호의 갯수
	...
	private void pagingData() {
		...
		// startPage = (끝 페이지 번호 - 화면에 보여질 페이지 번호의 갯수) +1
		...
		// 다음 버튼 생성 여부 = 끝 페이지 번호 * 한 페이지당 보여줄 게시글의 개수가 총 게시글의 수보다 크거나 같으면 false, 아니면 true
	}
