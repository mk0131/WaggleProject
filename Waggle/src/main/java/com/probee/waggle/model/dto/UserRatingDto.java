...
public class UserRatingDto {
	...
	public UserRatingDto(int ur_Code, int ur_Rate, String ur_Attr1, String ur_Attr2, String ur_Attr3, String ur_Stat) {
		super();
	...
	public String toString() {
		return "UserRatingDto [ur_Code=" + ur_Code + ", ur_Rate=" + ur_Rate + ", ur_Attr1=" + ur_Attr1 + ", ur_Attr2="
