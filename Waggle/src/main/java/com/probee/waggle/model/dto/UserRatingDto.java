...
public class UserRatingDto {
	...
	public UserRatingDto(int ur_No, int ur_Code, Double ur_Rate, String ur_Attr1, String ur_Attr2, String ur_Attr3,
			String ur_Stat) {
		super();
		this.ur_No = ur_No;
	...
	public Double getUr_Rate() {
		return ur_Rate;
	}

	public void setUr_Rate(Double ur_Rate) {
		this.ur_Rate = ur_Rate;
	}
