				...
				<table class="ongoing21-content">
					<tbody style="border-bottom: 1px solid;">
						<tr>
							...
							<td><input type="text" placeholder="Title" name="req_Title" required="required" value="${req_dto.req_Title}"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" placeholder="Point" name="req_Point" required="required" value="${req_dto.req_Point}"></td>
						</tr>
						<tr>
							<th>공인중개사 연락처</th>
