			...
			<form action="/board/rating" method="post">
				...
				<table class="ongoing21-content2 rate_bee_table">
					<tbody>
						...
						<tr>
							<td><input type="radio" id="ur_Attr1_1" name="ur_Attr1"
								class="rate_bee" value="1" required="required"> <label
								for="ur_Attr1_1" class="rate_bee">좋아요</label> <input
								type="radio" id="ur_Attr1_2" name="ur_Attr1" class="rate_bee"
								value="0"> <label for="ur_Attr1_2" class="rate_bee">보통이에요</label>
								<input type="radio" id="ur_Attr1_3" name="ur_Attr1"
								class="rate_bee" value="-1"> <label for="ur_Attr1_3"
								class="rate_bee">별로에요</label>
							<td>
						</tr>
						<tr>
							<th>응답이 빠르고 약속을 잘 지켜요</th>
						</tr>
						<tr>
							<td><input type="radio" id="ur_Attr2_1" name="ur_Attr2"
								class="rate_bee" value="1" required="required"> <label
								for="ur_Attr2_1" class="rate_bee">좋아요</label> <input
								type="radio" id="ur_Attr2_2" name="ur_Attr2" class="rate_bee"
								value="0"> <label for="ur_Attr2_2" class="rate_bee">보통이에요</label>
								<input type="radio" id="ur_Attr2_3" name="ur_Attr2"
								class="rate_bee" value="-1"> <label for="ur_Attr2_3"
								class="rate_bee">별로에요</label>
							<td>
						</tr>
						<tr>
						...
						<tr>
							<td><input type="radio" id="ur_Attr3_1" name="ur_Attr3"
								class="rate_bee" value="1" required="required"> <label
								for="ur_Attr3_1" class="rate_bee">좋아요</label> <input
								type="radio" id="ur_Attr3_2" name="ur_Attr3" class="rate_bee"
								value="0"> <label for="ur_Attr3_2" class="rate_bee">보통이에요</label>
								<input type="radio" id="ur_Attr3_3" name="ur_Attr3"
								class="rate_bee" value="-1"> <label for="ur_Attr3_3"
								class="rate_bee">별로에요</label>
							<td>
						</tr>
					</tbody>
			...
			<div class="ongoing21-all">
				...
				<table class="ongoing21-content">
					<tbody>
						...
						<tr>
							<th>내가 본 집 링크 첨부<br />(ex.직방, 다방 등등..)
							</th>
				...
				<div class="ongoing21-content-bottom">
					<textarea id="incontent" rows="12" cols="70" name="content"
						placeholder="요구사항을 입력해주세요" readonly="readonly">${req_dto.req_Detail }</textarea>
					...
					<table class="ongoing21-content2">
						<tbody>
							...
							<tr>
								<td><input type="radio" id="res_Attr1_1" name="res_Attr1">
									<label for="res_Attr1_1">좋아요</label> <input type="radio"
									id="res_Attr1_2" name="res_Attr1"> <label
									for="res_Attr1_2">보통이에요</label> <input type="radio"
									id="res_Attr1_3" name="res_Attr1"> <label
									for="res_Attr1_3">별로에요</label>
								<td>
							</tr>
							<tr>
								<th>수압</th>
							...
							<tr>
								<td><input type="radio" id="res_Attr2_1" name="res_Attr2">
									<label for="res_Attr2_1">좋아요</label> <input type="radio"
									id="res_Attr2_2" name="res_Attr2"> <label
									for="res_Attr2_2">보통이에요</label> <input type="radio"
									id="res_Attr2_3" name="res_Attr2"> <label
									for="res_Attr2_3">별로에요</label>
								<td>
							</tr>
							<tr>
								<th>외부소음</th>
							...
							<tr>
								<td><input type="radio" id="res_Attr3_1" name="res_Attr3">
									<label for="res_Attr3_1">좋아요</label> <input type="radio"
									id="res_Attr3_2" name="res_Attr3"> <label
									for="res_Attr3_2">보통이에요</label> <input type="radio"
									id="res_Attr3_3" name="res_Attr3"> <label
									for="res_Attr3_3">별로에요</label>
								<td>
							</tr>
							<tr>
								<th>냄새</th>
							...
							<tr>
								<td><input type="radio" id="res_Attr4_1" name="res_Attr4">
									<label for="res_Attr4_1">좋아요</label> <input type="radio"
									id="res_Attr4_2" name="res_Attr4"> <label
									for="res_Attr4_2">보통이에요</label> <input type="radio"
									id="res_Attr4_3" name="res_Attr4"> <label
									for="res_Attr4_3">별로에요</label>
								<td>
							</tr>
							<tr>
								<th>곰팡이</th>
							...
							<tr>
								<td><input type="radio" id="res_Attr5_1" name="res_Attr5">
									<label for="res_Attr5_1">좋아요</label> <input type="radio"
									id="res_Attr5_2" name="res_Attr5"> <label
									for="res_Attr5_2">보통이에요</label> <input type="radio"
									id="res_Attr5_3" name="res_Attr5"> <label
									for="res_Attr5_3">별로에요</label>
								<td>
							</tr>
							<tr>
								<th>벌레</th>
							...
							<tr>
								<td><input type="radio" id="res_Attr6_1" name="res_Attr6">
									<label for="res_Attr6_1">좋아요</label> <input type="radio"
									id="res_Attr6_2" name="res_Attr6"> <label
									for="res_Attr6_2">보통이에요</label> <input type="radio"
									id="res_Attr6_3" name="res_Attr6"> <label
									for="res_Attr6_3">별로에요</label>
								<td>
							</tr>
						</tbody>
					</table>
					...
					<form action="/board/rating" method="post">
						...
						<br />
						<div class="btn2" id="btn2">
							<button type="submit" value="평가">꿀벌 평가 완료</button>
							<button type="button" value="목록"
								onclick="location.href='/board/list'">목록으로 돌아가기</button>
						</div>
					</form>
