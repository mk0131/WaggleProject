...
<body>
	...
	<div class="middle">
		...
		<div><input type="text" placeholder="제목을 입력해주세요." name="req_Title"> </div>
		<div><span>내가 본 집 링크</span><input type="text" placeholder="주소를 입력해주세요." name="req_Link"></div>
		<div><span>방문기한</span><input type="date"> </div>
		<div>
			<span>내가 본 집 주소</span>
			<input type="hidden" name="home_Post" id="home_Post">
			<input type="text" name="home_Addr" id="home_Addr" readonly="readonly" onclick="kakaopost()"> 
	    ...
	    <div><span>심부름 비용:</span><input type="text" placeholder="최소금액 5000포인트" name="req_Point"></div>
	    <div>
